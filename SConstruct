...
nst_man = env.Install(instroot / 'share' / 'man' / 'man1', '#doc/nst.1')
nst_msg_man = env.Install(instroot / 'share' / 'man' / 'man1', '#doc/nst-msg.1')
nst_conf_man = env.Install(instroot / 'share' / 'man' / 'man5', '#doc/nst.conf.5')
env.Alias('install', nst_man)
env.Alias('install', nst_msg_man)
env.Alias('install', nst_conf_man)
...
nst_conf = env.Install(instroot / 'etc', '#data/nst.conf')
env.Alias('install', nst_conf)
