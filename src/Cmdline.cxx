...
Cmdline::Cmdline() :
	...
	window_class("c", "window-class", "defines the window class (default $TERM)", false, config::TERMNAME.data(), "string", *this),
	window_name("n", "window-name", "defines the window instance name (default $TERM)", false, config::TERMNAME.data(), "string", *this),
	...
	font("f", "font", "defines the font to use when st is run.", false, nst::config::FONT.data(),
